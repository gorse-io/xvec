...
func TestBM25MergeBaselineFixture(t *testing.T) {
	...
	if fixture.BaselineCommit != "58375ff7b8fdd0d6fc7d234e47567b179777883b" ||
		fixture.BM25HeaderSHA256 != "eb1a0a292fb8eddb3854b8256b6a0c7ad4920aabaa31a65b53e8fadde0ef0f8a" ||
		fixture.BM25SourceSHA256 != "73a6090ad0f22c7cc67a57dd4b794a00b8a38a1fe80d51d4700833acc1990389" ||
		fixture.ReducerHeaderHash != "b87f60888e230f39268dea6614d7aadca60f8945bc3bc0862f2fa026d1aeb43b" ||
		fixture.ReducerSourceHash != "7bebfd9d410c598e2970c0d3b7331b9623e2b481b28466b2eae7543af7d58b2e" {
	...
	if len(fixture.MergeCase.SourceDocumentCounts) != 2 || len(fixture.MergeCase.DeletedDocumentIDs) != 2 ||
		fixture.MergeCase.OutputDocumentCount != 3 || fixture.MergeCase.OutputTotalTokens != 6 ||
		len(fixture.MergeCase.OutputTerms) != 2 {
		t.Fatal("merge fixture drift")
	}
}
