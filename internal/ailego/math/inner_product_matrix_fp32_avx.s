...
TEXT ·inner_product_fp32_avx(SB), $8-28
	...
	LONG $0x4e59f4c5; BYTE $0x20 // vmulps	32(%rsi), %ymm1, %ymm1
...
LBB0_9:
	...
	LONG $0x1659ecc5               // vmulps	(%rsi), %ymm2, %ymm2
	LONG $0xc258fcc5               // vaddps	%ymm2, %ymm0, %ymm0
	LONG $0x5659e4c5; BYTE $0x20   // vmulps	32(%rsi), %ymm3, %ymm2
	LONG $0x5e59dcc5; BYTE $0x40   // vmulps	64(%rsi), %ymm4, %ymm3
	LONG $0xca58f4c5               // vaddps	%ymm2, %ymm1, %ymm1
	LONG $0xc358fcc5               // vaddps	%ymm3, %ymm0, %ymm0
	LONG $0x5659d4c5; BYTE $0x60   // vmulps	96(%rsi), %ymm5, %ymm2
	LONG $0xca58f4c5               // vaddps	%ymm2, %ymm1, %ymm1
