...
BM25 scoring and block-max bounds, the FTS query parser, phrase/boolean
execution, physical segment merging, and Collection integration remain later
v0.5 units. No placeholder score is stored in this format.
