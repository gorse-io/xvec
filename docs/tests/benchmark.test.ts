...
test('current eight runs, four categories, and all 13 chart metrics match the published measurements', () => {
  ...
  const expected = [
    [1973.120882,313.688966,87.984,4.05299,5.194296,6.215429,2.939387,3.726695,4.152706,62.457237,6.521406,55.928957,1249772],
    [2285.309151,273.20439,81.892,3.498585,5.234352,6.952462,3.422636,5.406221,5.921854,44.980547,6.133945,38.8244,582392],
    [1875.311196,290.173107,98.96,4.263742,5.599398,6.996887,3.197955,4.042153,4.532387,66.227026,7.415381,58.804459,1673672],
    [1512.037726,216.490614,98.474,5.28701,8.976525,11.737435,4.250335,5.909212,6.700442,61.840791,5.46147,56.333318,656056],
    [876.350934,127.939498,99.681,9.124755,13.548858,17.712583,7.433705,9.578449,10.787145,81.753989,5.139241,76.607775,1847288],
    [1733.569829,289.796495,99.507,4.61225,6.468389,8.37713,3.242727,4.615804,5.367489,69.127283,4.938918,64.161354,800604],
    [1096.110653,213.970301,99.714,7.295882,9.411192,10.602209,4.446753,5.711022,6.24881,102.279969,3.787315,98.48603,2253156],
  ...
  assert.equal(records[0].backend_version, 'a2766b5202e5694d169946173a64367928bd6998');
});
...
test('Flat measurements omit HNSW fields and remain in a separate comparison group', () => {
  ...
  assert.deepEqual(seriesFor(flat, 'concurrent_qps').map((series) => series.data), [
    [509.530878, 317.337282, 219.893384, 167.715352],
