...
The current implementation supports Flat, HNSW, HNSW-RaBitQ, IVF, and Vamana vector
...
scalar codes. If compaction is required and the schema contains DiskANN, FTS,
IVF SOAR, or binary INVERT state, Optimize returns `ErrNotSupported` before
